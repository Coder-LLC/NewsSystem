...
<html>
  <head>
    <title>新闻查询结果</title>
     <style type="text/css">
	#all{ width:100%;height:1000px; background-color:#FFFFFF;float:left;}
  ...
  <body>
	...
	<div id="all">
	  <div id="top">
		<p><font style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;欢迎使用新闻管理系统！</font></p>		
	  </div>
		<div id="top1">&nbsp;&nbsp;&nbsp;&nbsp;管理员：
		<% 
		...
		<%
          ...
          if(news==null){
        	 out.print("<script>alert('主题编号不存在，请重新查询');location='admin-select-news.jsp';</script>");
          }
          List comment=new ArrayList();
  	      comment=CommentBiz.getCommentByNid(nid);//使用传过来的nid查询评论
		...
		<p><a href="servlet/admin_editcomment_contorl?Id=${comment.cid }"onclick="javascript:if(confirm('确定要删除此信息吗？')){return true;}return false;">删除</a></p>
		</c:forEach>
        </div>
		<div id="bottom">
		<hr/>
